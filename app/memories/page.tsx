import MemoryCreator from "@/components/memory-creator"
...
export default function MemoriesPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-pink-50">
      ...
      <div className="relative py-12 mb-8 bg-gradient-to-r from-pink-100 to-purple-100">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-pink-700 mb-4">Criador de Cartão de Memórias</h1>
